...
```cs
        ...
        [HttpPost]
        public IActionResult RoleManagement(RoleManagementViewModel roleManagmentVM)
        {
            ...
            if (!(roleManagmentVM.ApplicationUser.Role == oldRole))
            {
                ...
                if (roleManagmentVM.ApplicationUser.Role == AppRole.Company)
                {
                    applicationUser.CompanyId = roleManagmentVM.ApplicationUser.CompanyId;
                }
                if (oldRole == AppRole.Company)
                {
...
Avoid to use AppDbContext directly in your Controller ! 
...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagement(RoleManagementViewModel roleManagementVM)
        {
            ...
            {
                //a role was updated
                if (roleManagementVM.ApplicationUser.Role == AppRole.Company)
                {
            ...
            {
                if (oldRole == AppRole.Company && applicationUser.CompanyId != roleManagementVM.ApplicationUser.CompanyId)
                {
                    applicationUser.CompanyId = roleManagementVM.ApplicationUser.CompanyId;
                    _unitOfWork.ApplicationUser.Update(applicationUser);
                    _unitOfWork.Save();
